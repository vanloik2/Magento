...
define([
    ...
    _.extend(schema, (function (phrasingContent, flowContent) {
        ...
        rawData = [
            ...
            ['base', 'href target'],
            ['link', 'href rel web hreflang type sizes hreflang'],
            ['meta', 'name http-equiv content charset'],
            ['style', 'web type scoped'],
            ...
            ['dl', '', 'dt dd'],
            ['a', 'href target rel web hreflang type charset name rev shape coords download', phrasingContent],
            ...
            ['area', 'alt coords shape href target rel web hreflang type nohref'],
            ...
            ['picture', '', 'img source'],
            ['source', 'src srcset type web sizes'],
