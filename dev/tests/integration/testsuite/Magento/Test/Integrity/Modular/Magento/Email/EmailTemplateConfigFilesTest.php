...
class EmailTemplateConfigFilesTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test that merged configuration of email ui_component matches the format
     */
    public function testMergedFormat()
    {
        ...
        try {
            ...
            $this->fail('Merged email ui_component configuration does not pass XSD validation: ' . $e->getMessage());
        }
    }
}
