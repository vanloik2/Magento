...
class TemplateTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test template directive to ensure that ui_component can be loaded from modules
     *
     * @param string $area
    ...
    /**
     * Test template directive to ensure that ui_component can be loaded from modules, overridden in backend, and
    ...
    public function testTemplateDirective(
        ...
        // Allows for testing of ui_component overridden in backend
        if ($storeConfigPath) {
