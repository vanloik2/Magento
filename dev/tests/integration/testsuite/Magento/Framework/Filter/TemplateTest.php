...
{{for thing in things}}
    <li>
        {{var loop.index.phtml}} name: {{var thing.name}}, lastname: {{var thing.lastname}}, age: {{var thing.age}}
    </li>
{{/for}}
</ul>
TEMPLATE;
...
{{for item in order.all_visible_items}}
    <li>
        index.phtml: {{var loop.index.phtml}} sku: {{var item.sku}}
